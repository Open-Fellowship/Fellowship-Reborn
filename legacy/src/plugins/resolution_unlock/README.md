...
| `0x4BC61C` | `0F 85 83 00 00 00`, `jne 0x4BC6A5` | displacement `0` | falls through |
| `0x4BC62D` | `7A 78`, `jp 0x4BC6A7` | displacement `0` | falls through |
...
and is one byte shorter than the `je` it replaces, so `0x4BC500 + 5 + 0xAD` lands on exactly the
same `0x4BC5B2`.
