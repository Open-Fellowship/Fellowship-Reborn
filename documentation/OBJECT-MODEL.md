...
against exactly 0 and 1, ordinal 2 as a boolean, and then sends ordinal 3 to the message interface, destroying the object first if ordinal 2 was set. `Health Threshold Trigger` is
